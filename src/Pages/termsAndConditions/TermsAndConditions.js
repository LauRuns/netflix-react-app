...
export const TermsAndConditions = () => {
	return (
		<div className="terms-conditions-container">
			<Header title="Terms and conditions" lg center />
			<h3>Welcome to Jtaclogs!</h3>
			<br />
			<div>
				These terms and conditions outline the rules and regulations for the use of Jtaclogs,
				located at jtaclogs.nl.
			</div>
			<br />
			<div>
				By accessing this website we assume you accept these terms and conditions. Do not continue
				to use jtaclogs.nl if you do not agree to take all of the terms and conditions stated on
				this page.
			</div>
			<br />
			<div>
			...
			<br />
			<div>
				We employ the use of cookies. By accessing jtaclogs.nl, you agreed to use cookies in
				agreement with Jtaclogs's Privacy Policy. Most interactive websites use cookies to let us
				retrieve the user's details for each visit. Cookies are used by our website to enable the
				functionality of certain areas to make it easier for people visiting our website. Some of
			...
			<br />
			<div>
				Unless otherwise stated, Jtaclogs and/or its licensors own the intellectual property rights
				for all material on jatclogs.nl. All intellectual property rights are reserved. You may
				access this from jatclogs.nl for your own personal use subjected to restrictions set in
			...
			<div>
				...
				<div className="list">
					<ul>
						<li>Republish material from jatclogs.nl</li>
						<li>Sell, rent or sub-license material from jatclogs.nl</li>
						<li>Reproduce, duplicate or copy material from jatclogs.nl</li>
						<li>Redistribute content from jatclogs.nl</li>
					</ul>
				</div>
				<br />
				...
				information in certain areas of the website. Jtaclogs does not filter, edit, publish or
				review Comments prior to their presence on the website. Comments do not reflect the views
				and opinions of Jtaclogs,its agents and/or affiliates. Comments reflect the views and
				opinions of the person who post their views and opinions. To the extent permitted by
				applicable laws, Jtaclogs shall not be liable for the Comments or for any liability, damages
				or expenses caused and/or suffered as a result of any use of and/or posting of and/or
				appearance of the Comments on this website.
				<br />
				Jtaclogs reserves the right to monitor all Comments and to remove any Comments which can be
				...
				<br />
				You hereby grant Jtaclogs a non-exclusive license to use, reproduce, edit and authorize
			...
			<div>
				...
				visibility of the hyperlink compensates the absence of Jtaclogs; and (d) the link is in the
				...
				linking to our website, you must inform us by sending an e-mail to Jtaclogs. Please include
				...
				<br />
				<b>
					No use of Jtaclogs's logo or other artwork will be allowed for linking absent a trademark
					license agreement.
				</b>
			</div>
			<br />
